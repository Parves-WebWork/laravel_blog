						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="d-grid">
										<a class="btn my-4 shadow-sm btn-white" href="{{url('authorized/google')}}"> <span class="d-flex justify-content-center align-items-center">
											<img class="me-2" src="{{asset('adminbackend/assets/images/icons/search.svg')}}" width="16" alt="Image Description">
											<span>Sign Up with Google</span>
											</span>
										</a> <a href="{{url('#')}};" class="btn btn-facebook"><i class="bx bxl-facebook"></i>Sign Up with Facebook</a>
									</div>
									...
									<div class="form-body">
										...
										<form method="post" action="{{route('admin.register.create')}}" class="row g-3">
                                            @csrf

											<div class="col-sm-12">
												<label for="inputFirstName" class="form-label">Your  Name</label>
												<input name="name" type="name" class="form-control" id="inputFirstName" placeholder="Full Name">
											</div>
                                            ...
                                            <div class="col-12">
												<label for="inputChoosePassword" class="form-label">Re-type Password</label>
												<div class="input-group" id="show_hide_password">
