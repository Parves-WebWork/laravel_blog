                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('update.blog') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_tags" value="{{$blogs->blog_tags}}" class="form-control" type="text"  data-role="tegsinput">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_description" value="{{$blogs->blog_description}}" class="form-control" type="text"  data-role="tegsinput">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_image" id="blog_image" class="form-control" type="file" id="image">
                                </div>
                            </div>
