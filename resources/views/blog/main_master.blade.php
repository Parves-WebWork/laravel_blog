...
<head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" href="{{asset('blogfontend/images/favicon.ico')}}" type="image/x-icon">
    <link rel="icon" href="{{asset('blogfontend/images/favicon.ico')}}" type="image/x-icon">
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('blogfontend/images/apple-touch-icon.png')}}">
    
    <!-- THEME CSS
	================================================== -->
    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{asset('blogfontend/plugins/bootstrap/css/bootstrap.min.css')}}">
    <!-- FontAwesome -->
    <link rel="stylesheet" href="{{asset('blogfontend/plugins/font-awesome/css/font-awesome.min.css')}}">
    <!-- Slick Carousel -->
    <link rel="stylesheet" href="{{asset('blogfontend/plugins/slick-carousel/slick.css')}}">
    <link rel="stylesheet" href="{{asset('blogfontend/plugins/slick-carousel/slick-theme.css')}}">
    <!-- manin stylesheet -->
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xs-12 col-sm-3 col-md-3">
                ...
                <div class="logo">
                    <a href="index.html">
                        <img src="{{asset('blogfontend/images/logos/logo.png')}}" alt=""> <!-- Replace Logo Here -->
                    </a>
                </div>
                <!-- End Logo -->
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
                <div class="top-ad-banner float-right">
                    <a href="#">
                        <img src="{{asset('blogfontend/images/news/ad-pro.png')}}" class="img-fluid" alt="banner-ads">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg site-main-nav navigation">
                      <a class="navbar-brand d-lg-none" href="index.html">
                        <img src="{{asset('blogfontend/images/logos/footer-logo.png')}}" alt=""> 
                     </a>
        ...
        <div class="row no-gutters">
            <div class="col-md-6 col-xs-12 col-lg-4">
                <div class="featured-slider mr-md-3 mr-lg-3">
                    <div class="item" style="background-image:url({{asset('blogfontend/images/news/img-1.jpg')}})">
                        <div class="post-content">
            ...
            <div class="col-md-6 col-xs-12 col-lg-4">
                 <div class="featured-slider mr-lg-3">
                    <div class="item" style="background-image:url({{asset('blogfontend/images/news/img-2.jpg')}})">
                        <div class="post-content">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-4">
                <div class="row mt-3 mt-lg-0">
                    <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                        <div class="post-featured-style" style="background-image:url({{asset('blogfontend/images/news/news-02.jpg')}})">
                            <div class="post-content">
                    ...
                    <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                        <div class="post-featured-style" style="background-image:url({{asset('blogfontend/images/news/news-04.jpg')}})">
                            <div class="post-content">
...
<section class="block-wrapper">
    ...
    <div class="news-style-one-slide">
        <div class="item">
            <div class="post-block-wrapper clearfix mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-01.jpg')}}" alt="post-image"/>
                    </a>
                </div>
                <div class="post-content">
            ...
            <div class="post-block-wrapper clearfix mb-5 ">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-02.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
        ...
        <div class="item">
            <div class="post-block-wrapper clearfix mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-03.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title ">
            ...
            <div class="post-block-wrapper clearfix mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-04.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
        ...
        <div class="item">
            <div class="post-block-wrapper clearfix  mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-05.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
            ...
            <div class="post-block-wrapper clearfix  mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-06.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
        ...
        <div class="item">
            <div class="post-block-wrapper clearfix  mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-07.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
            ...
            <div class="post-block-wrapper clearfix  mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-08.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
            ...
            <div class="post-block-wrapper clearfix">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-09.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
    ...
    <div class="post-overlay-wrapper">
        <div class="post-thumbnail">
            <img class="img-fluid" src="{{asset('blogfontend/images/news/news-15.jpg')}}" alt="post-thumbnail"/>
        </div>
        <div class="post-content">
    ...
    <div class="post-list-block">
        ...
        <div class="post-block-wrapper post-float">
            <div class="post-thumbnail">
                <a href="single-post.html">
                    <img class="img-fluid" src="{{asset('blogfontend/images/news/news-11.jpg')}}" alt="post-thumbnail"/>
                </a>
            </div>
    ...
    <div class="post-slide">
        <div class="item">
            <div class="post-overlay-wrapper clearfix">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-16.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
            ...
            <div class="post-overlay-wrapper clearfix mt-3">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-18.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
        ...
        <div class="item ">
            <div class="post-overlay-wrapper clearfix">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-17.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
            ...
            <div class="post-overlay-wrapper mt-3 clearfix">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{asset('blogfontend/images/news/news-19.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="block">
                    ...
                    <div class="post-overlay-wrapper clearfix">
                        <div class="post-thumbnail">
                            <img class="img-fluid" src="{{asset('blogfontend/images/news/news-13.jpg')}}" alt="post-thumbnail"/>
                        </div>
                    ...
                    <div class="post-list-block">
                        ...
                        <div class="post-block-wrapper post-float clearfix">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{asset('blogfontend/images/news/news-12.jpg')}}" alt="post-thumbnail"/>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="block">
                    ...
                    <div class="post-list-block">
                        ...
                        <div class="post-block-wrapper post-float clearfix">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{asset('blogfontend/images/news/news-01.jpg')}}" alt="post-thumbnail"/>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="block">
                    ...
                    <div class="post-list-block">
                        <div class="post-block-wrapper post-float clearfix">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{asset('blogfontend/images/news/news-10.jpg')}}" alt="post-thumbnail"/>
                            </div>
                        ...
                        <div class="post-block-wrapper post-float clearfix">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{asset('blogfontend/images/news/news-14.jpg')}}" alt="post-thumbnail"/>
                            </div>
    ...
    <div class="post-list-block">
        <div class=" review-post-list">
            <div class="top-author">
                <img src="{{asset('blogfontend/images/news/author-01.jpg')}}" alt="author-thumb">
                <div class="info">
            ...
            <div class="top-author">
                <img src="{{asset('blogfontend/images/news/author-02.jpg')}}" alt="author-thumb">
                <div class="info">
            ...
            <div class="top-author">
                <img src="{{asset('blogfontend/images/news/author-03.jpg')}}" alt="author-thumb">
                <div class="info">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12 col-lg-6 text-center">
                <a href="index.html"><img src="{{asset('blogfontend/images/logos/footer-logo.png')}}" alt="" class="img-fluid"></a>
...
<script src="{{asset('blogfontend/plugins/jquery/jquery.js')}}"></script>
<!-- Bootstrap jQuery -->
<script src="{{asset('blogfontend/plugins/bootstrap/js/bootstrap.min.js')}}"></script>
<!-- Slick Slider -->
<script src="{{asset('blogfontend/plugins/slick-carousel/slick.min.js')}}"></script>
<!-- Google Map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCC72vZw-6tGqFyRhhg5CkF2fqfILn2Tsw"></script>
<script src="plugins/google-map/gmap.js"></script>
<!-- main js -->
<script src="{{asset('blogfontend/js/custom.js')}}"></script>
