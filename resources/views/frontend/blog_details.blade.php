...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="   {{asset('fontend/assets/css/templatemo-stand-blog.css')}}">
...
-->
  ...
  <body>
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      ...
                      <a href="{{route('blog.details',$blogs->id)}}"><h4>{{$blogs->blog_title}}</h4></a>
                      <ul class="post-info">
                        <li><a href="#">Admin</a></li>
                        <li><a href="#">{{Carbon\carbon::parse($blogs->created_at)->diffForHumans()}}</a></li>
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="sidebar-item recent-posts">
                    ...
                    <div class="content">
                      <ul>
                        <li><a href="{{route('blog.details',$blogs->id)}}">
                          <img src="{{asset($all->blog_image)}}" alt="">
                          <h5>{{$all->blog_title}}</h5>
    ...
    <script src="   {{asset('fontend/assets/js/owl.js')}}"></script>
